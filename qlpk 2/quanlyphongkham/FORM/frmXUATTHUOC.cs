    ...
    public partial class frmXUATTHUOC : Form
    {
        ...
        void loadlist(){
            ...
            try
            {
                ...
                if (gcDSBN.DataSource != null)
                {
                    ...
                    {
                        string id_nhapkho = dtCTTT.Rows[i]["ID_CTPHIEUNHAP"].ToString();
        ...
        private void btnTT_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (daoXT.KiemTraHoaDonDaTT(lbId_TNHAN.Text) == 0)
                {
                    ...
                    HOA_DON hoadon = layTTHD(hd_id, 1, "Đã thanh toán");
        ...
        private void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            try
            {
                ...
                txtDiaChi.Text = gridView1.GetFocusedRowCellValue("BN_DIACHI").ToString();
        ...
        private void gridView2_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            try
            {
                ...
                txtTrangThai.Text = gridView2.GetFocusedRowCellValue("HD_TRANGTHAI").ToString();
            }
            catch { }
        }
