...
namespace quanlyphongkham.DAO
{
    class DAO_XUATTHUOC
    {
        ...
        public DataTable getToaThuocByBN(string ngay, string denngay)
        {
            ...
            string fromday = ngay.Substring(0, 10);
            ...
            cmd.Parameters["@dengay"].Value = DateTime.ParseExact(today, "dd/MM/yyyy HH:mm:ss", null);
            con.Open();
        ...
        public string KiemTraHoaDonDaHuy(string tn_id)
        {
            string result = "";
            try
            {
                SqlConnection con = new SqlConnection(db.connectionStr);
                SqlCommand cmd = new SqlCommand("KiemTraHoaDonDaHuy", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@tn_id", SqlDbType.NVarChar, 15);
                cmd.Parameters.Add("@dem", SqlDbType.NVarChar,20);
                cmd.Parameters["@dem"].Direction = ParameterDirection.Output;
                ...
                con.Open();
                cmd.ExecuteNonQuery();
                result = cmd.Parameters["@dem"].Value.ToString();
                con.Close();
            }
            catch { }
            return result;
