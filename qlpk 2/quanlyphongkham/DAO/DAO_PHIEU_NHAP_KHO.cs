...
namespace quanlyphongkham.DAO
{
    class DAO_PHIEU_NHAP_KHO
    {
        ...
        public DataTable KiemTraThuocDaCho(string id)
        {
            SqlConnection con = new SqlConnection(db.connectionStr);
            SqlCommand cmd = new SqlCommand("KiemTraThuocDaCho", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@id_ctpn", SqlDbType.NVarChar, 20);
            cmd.Parameters["@id_ctpn"].Value = id;
